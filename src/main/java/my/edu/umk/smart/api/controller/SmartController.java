...
public class SmartController {
    ...
    public ResponseEntity<String> radiusUser(@RequestBody CandidatePayload payload) {
    	...
    	final String address = payload.getPrimaryAddress().getAddress1()+","+payload.getPrimaryAddress().getAddress2()+","+payload.getPrimaryAddress().getAddress3();
        ...
        mysqlJdbcTemplate.update(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
                ...
                ps.setString(2, payload.getUserPayload().getNric());		//password
